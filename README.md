...
- `Tracker/Tracker.Server`: raw / tracked SSL-Vision data を表示する ASP.NET Core viewer/server。
...
- .NET SDK 10.0
- `Tracker.Server` を実行する場合は SSL-Vision 互換の packet 送信元
...
`Tracker.Server` の設定、UI、profile switch、API の詳細は [Tracker/Tracker.Server/README.md](Tracker/Tracker.Server/README.md) を参照してください。
