    ...
    private SnapshotReplaySession CreateSnapshotReplaySession()
    {
        ...
        File.WriteAllText(
            ...
            JsonSerializer.Serialize(new
            {
                ...
                replayTimelineReceivedAt = new DateTimeOffset(2026, 5, 12, 12, 0, 0, TimeSpan.Zero),
                replayTimelineKind = "diagnostics-entry",
                diagnosticsLineNumber = 1,
                renderFrameNumber = 8100,
                renderReceivedAt = new DateTimeOffset(2026, 5, 12, 12, 0, 0, TimeSpan.Zero),
