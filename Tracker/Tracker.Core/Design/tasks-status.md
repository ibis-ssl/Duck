...
- ID: TRACKER-017
- Title: runtime profile 表示・操作 UI を追加する
- Phase: ui
- Status: in_progress
- Size: medium
- Dependencies: TRACKER-014, TRACKER-016 が完了していること
- Exit Criteria:
  - profile 名表示と profile 切替要求 UI が表示・操作できる。
...
| TRACKER-017 | runtime profile 表示・操作 UI を追加する | ui | in_progress | TRACKER-014, TRACKER-016 | profile 名表示と profile 切替要求 UI が表示・操作できる。 |
