...
- Exit Criteria:
  - 実装開始前に、PR #9 `https://github.com/ibis-ssl/Duck/pull/9` の `TRACKER-040` 機能設計と保守性設計の分離、および CaptureOn session folder 構造を含む設計・tracking 差分についてユーザーの設計承認を得ている
