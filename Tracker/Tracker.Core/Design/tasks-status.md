...
| TRACKER-024 | Kalman 標準準拠の検証と release 判定をやり直す | verification | pending | TRACKER-023 | Kalman 化後の focused/full test と review report が存在し、設計書の「v1 は直線運動前提の Kalman filter を標準とする」に対して未解決 blocker が残っていない。 |
