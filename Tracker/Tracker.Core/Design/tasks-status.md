...
| TRACKER-033 | Core tracker engine の巨大ファイルを責務別に細分化し日本語コメントを追加する | maintenance | in_progress | TRACKER-032 | `TrackerExecutionContracts.cs` を中心に巨大な engine 実装を責務別ファイルへ分割し、主要 class / property / method に日本語コメントを追加する。 |
