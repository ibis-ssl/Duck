...
| design | in-progress | `raw-vision-viewer-plan.md` records Issue #10 source options, same-tick acquisition strategy, geometry policy, diagnostics-aligned split / overlay UI behavior, rejected alternatives, and glossary entries for named concepts before TDD begins. |
