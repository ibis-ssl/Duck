...
- `RAW-VISION-016`: README / manual evidence、最終検証、review、PR #15 ready 化を完了する。検証 report、設計用語脚注化 review、final review、PR #15 本文同期は完了。UI を見ながらの動作確認はユーザー側で実施し、draft 解除はその後に判断する。
